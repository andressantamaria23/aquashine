...
if (isset($_POST['enviar'])) {
    ...
    if ($resultado) {
        ...
        location.assign("viewservicesU.php");</script>';
    } else {
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto">
            ...
            <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" class="grid grid-cols-2 gap-x-6 gap-y-4">
                <input type="hidden" name="idReservas" value="<?php echo htmlspecialchars($idReservas); ?>">

                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="fecha_reserva">Fecha reserva</label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                           type="date" id="fecha_reserva" name="fecha_reserva" value="<?php echo $fecha_reserva;?>" >
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="hora_reserva">Hora reserva</label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                           type="time" id="hora_reserva" name="hora_reserva" value="<?php echo $hora_reserva;?>" >
                </div>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="FK_servicios">Servicio</label>
