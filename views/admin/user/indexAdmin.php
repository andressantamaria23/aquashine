...
<?php
    while ($fila = mysqli_fetch_assoc($resultado)) {
        echo '<tr class="border-b border-blue-900 hover:bg-white-50 bg-white text-black">';
        echo '<th scope="row" class="px-6 py-5 border-x border-blue-900">'. $fila['idUsuario'] .'</th>';
        echo '<td class="px-6 py-5 border-x border-blue-900">'. $fila['nom_usuario'] . '</td>';
        echo '<td class="px-6 py-5 border-x border-blue-900">'. $fila['apel_usuario'] .'</td>';
        echo '<td class="px-6 py-5 border-x border-blue-900">'. $fila['fecha_nacimiento'] .'</td>';
        echo '<td class="px-6 py-5 border-x border-blue-900">'. $fila['email'] .'</td>';
        echo '<td class="px-6 py-5 border-x border-blue-900">'. $fila['nom_rol'] .'</td>';
        ...
        echo "<td><a class='inline-block rounded bg-red-500 text-neutral-50 shadow-[0_4px_9px_-4px_rgba(51,45,45,0.7)] hover:bg-red-600 hover:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:bg-red-800 focus:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] active:bg-red-700 active:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out focus:outline-none focus:ring-0' href='javascript:void(0);' onclick=\"confirm('¿Estás seguro de que deseas eliminar este usuario?') ? window.location.href='../../../controller/Admin/deleteAdmin.php?idUsuario=" . $fila['idUsuario'] . "' : null;\">Eliminar</a></td>";
        echo '</tr>';
    }
?>
</tbody>
