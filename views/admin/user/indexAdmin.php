...
$sql = "SELECT * FROM usuario INNER JOIN rol ON rol.idRol = usuario.FK_rol";
...
<div class="sidebar fixed top-0 bottom-0 left-[-300px] duration-300 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 shadow h-screen" id="sidebar">
    <div class="text-gray-100 text-xl">
        ...
        <div class="leading-7 text-left text-sm font-thin mt-2 w-4/5 mx-auto hidden" id="submenu">
            <a href="agregarU.php" class="mb-3 cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1">Agregar</a>
        ...
        <div class="leading-7 text-left text-sm font-thin mt-2 w-4/5 mx-auto hidden" id="Roles">
            <a href="../roles/agregarRol.php" class="mb-3 cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1">Agregar</a>
...
<div class="content">
    <div class="container mx-auto mt-10">
        ...
        <hr class="my-4 text-gray-600">
        <a href="agregarU.php" role="button" class="mb-7 inline-block rounded-full bg-emerald-500 text-sm text-white hover:bg-emerald-700 px-6 pt-2.5 pb-2">Agregar</a>
            ...
            <table id="myTable" class="table table-hover table-striped mt-4 text-center">
                ...
                <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
                    <tr class="border-b border-gray-200 bg-white hover:bg-gray-100 " >
                        ...
                        <td  class="px-5 py-5 text-sm border-x border-y"><?php echo $row['apel_usuario']; ?></td>
...
<script>
    ...
    function openModal(id, nombre) {
        ...
        document.querySelector("#deleteModal a").href = `../../../controller/Admin/deleteAdmin.php?idUsuario=${id}`;
