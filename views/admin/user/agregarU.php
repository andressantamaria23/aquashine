...
<div class="text-center text-4xl font-bold text-gray-900 mt-2 ">REGISTAR USUARIO  </div>
        <!-- Table responsive wrapper -->
        <hr class="my-4 text-gray-600">

        
        <form action="../../../controller/Admin/agregarUAd.php" method="POST" class=" text-gray-200 justify-center mt-2">
          <div class=" grid grid-cols-2">
            <div class="mx-4 mb-4">
              <div class="relative mb-6 hidden" data-twe-input-wrapper-init>
                <input type="number" class="peer block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary" id="idUsuario" name="idUsuario" placeholder="ID" oninput="handleInput(this)" />
                <label for="idUsuario" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.80rem] peer-focus:scale-[0.8] peer-focus:text-primary">ID </label>
            </div>
            <div class="relative mb-6 mt-2" data-twe-input-wrapper-init>
                <input type="text" class="peer block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary" id="nom_usuario" name="nom_usuario" placeholder="Nombre" oninput="handleInput(this)" />
                <label for="nom_usuario" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.80rem] peer-focus:scale-[0.8] peer-focus:text-primary">Nombre </label>
            </div>
    
            <div class="relative mb-6" data-twe-input-wrapper-init>
                <input type="text" class="peer block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary" id="apel_usuario" name="apel_usuario" placeholder="Apellido" oninput="handleInput(this)" />
                <label for="apel_usuario" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.80rem] peer-focus:scale-[0.8] peer-focus:text-primary">Apellido</label>
            </div>
            <div class="relative mb-6" data-twe-input-wrapper-init>
              <input type="date" class="peer block w-full appearance-none rounded border border-gray-200 bg-transparent px-3 py-2 leading-tight text-gray-700 outline-none transition-all duration-200 ease-linear focus:ring-2 focus:ring-blue-600" id="fecha_nacimiento" name="fecha_nacimiento" placeholder=" " oninput="handleInput(this)" />
              <label for="fecha_nacimiento" class="pointer-events-none absolute left-3 -top-3.5 bg-white px-1 text-gray-500 transition-all duration-200 ease-out origin-top-left transform scale-75 peer-focus:-top-3.5 peer-focus:scale-75 peer-focus:-translate-y-0 peer-placeholder-shown:top-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:text-blue-600">Fecha Nacimiento</label>
          </div>
            </div>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init>
                <input type="text" class=" peer block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary" id="email" name="email" placeholder="email" oninput="handleInput(this)" />
                <label for="email" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.80rem] peer-focus:scale-[0.8] peer-focus:text-primary">email</label>
            </div>
            <div class="relative mb-6" data-twe-input-wrapper-init>
                <input type="password" class="peer block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary" id="contraseña" name="contraseña" placeholder="contraseña" oninput="handleInput(this)" />
                <label for="contraseña" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.80rem] peer-focus:scale-[0.8] peer-focus:text-primary">contraseña</label>
            </div>
            <div class="relative mb-6 " data-twe-input-wrapper-init>
                <input type="number" class="peer block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary" id="FK_rol" name="FK_rol" placeholder="rol" oninput="handleInput(this)" />
                <label for="FK_rol" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.80rem] peer-focus:scale-[0.8] peer-focus:text-primary">rol</label>
            </div>
