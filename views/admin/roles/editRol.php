    ...
    <form action="<?=$_SERVER['PHP_SELF']?>" method="POST" class="text-gray-200 justify-center mt-2">
        <div class="">
            ...
            <div class="mb-6 mt-2" data-twe-input-wrapper-init>
                    <label for="idRol" class="  block mb-2 text-neutral-500">ID ROL</label>
                    <input type="text" class="block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none text-gray-900" id="idRol" name="idRol" placeholder="Nombre" oninput="handleInput(this)" value="<?php echo $idRol;?>"  />
                </div>
                <div class="mb-6 mt-2" data-twe-input-wrapper-init>
                    <label for="nom_rol" class="block mb-2 text-neutral-500">Nombre Rol</label>
                    <input type="text" class="block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none text-gray-900" id="nom_rol" name="nom_rol" placeholder="Nombre" oninput="handleInput(this)" value="<?php echo $nom_rol;?>"  />
                </div>
                <div class="mb-6" data-twe-input-wrapper-init>
                    <label for="descripcion" class="block mb-2 text-neutral-500">Descripcion</label>
                    <input type="text" class="block min-h-[auto] w-full rounded border border-gray-200 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none text-gray-900" id="descripcion" name="descripcion" placeholder="Descripcion" oninput="handleInput(this)" value="<?php echo $descripcion;?>"  />
                </div>
