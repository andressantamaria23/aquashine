                ...
                <div class="sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] duration-1000
                 ...
                 <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center rounded-md">
                        ...
                        <a href="agregarRol.php" class="block cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1">Agregar</a>
                        <a href="indexR.php" class="block cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1">Visualizar</a>
                        </div>
                        ...
                        <div class="leading-7 text-left text-sm font-thin mt-2 w-4/5 mx-auto hidden" id="submenu">
    <a href="agregarRol.php" class="block cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1">
        Agregar
    </a>
    <a href="indexRol.php" class="block cursor-pointer p-2 hover:bg-gray-700 rounded-md mt-1">
        Visualizar
    </a>
</div>
...
<table class="min-w-full text-left text-sm whitespace-nowrap">
  ...
  <?php
         while ($fila = mysqli_fetch_assoc($resultado)) {
            ...
            echo '<th scope="row" class="px-6 py-5 border-x dark:border-neutral-600">'. $fila['idRol'] .'</th>';
            ...
            echo "<td><a class='mx-auto inline-block rounded bg-indigo-500 text-neutral-50 shadow-[0_4px_9px_-4px_rgba(51,45,45,0.7)] hover:bg-indigo-600 hover:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:bg-indigo-800 focus:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] active:bg-indigo-700 active:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out focus:outline-none focus:ring-0' href='editRol.php?idRol=" . $fila['idRol'] . "''>Editar</a></td>";
             echo "<td><a class='inline-block rounded bg-red-500 text-neutral-50 shadow-[0_4px_9px_-4px_rgba(51,45,45,0.7)] hover:bg-red-600 hover:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:bg-red-800 focus:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] active:bg-red-700 active:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out focus:outline-none focus:ring-0' href='../../../controller/Admin/deleteRol.php?idRol=" . $fila['idRol'] . "''>Eliminar</a></td>";
            echo '</tr>';
        }
    ?>
</tbody>
