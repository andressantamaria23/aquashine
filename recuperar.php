    ...
    <section class="relative h-screen bg-cover bg-center" style="background-image: url('static/img/pexels-pixabay-372810.jpg');">
        ...
        <div class="relative z-10 flex items-center justify-center h-full">
            <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h2 class="text-2xl font-semibold text-center mb-6">CAMBIAR CONTRASEÑA</h2>
                <form action="controller/Admin/recuperar.php" method="post">
    <div class="relative flex w-full flex-col flex-wrap items-stretch mb-4 hidden">
        <input type="hidden" name="idUsuario" placeholder="idUsuario" value="<?php echo isset($_GET['idUsuario']) ? $_GET['idUsuario'] : ''; ?>" required />
    </div>
    <div class="relative flex w-full flex-col flex-wrap items-stretch mb-4 hidden">
        <input type="hidden" name="token" placeholder="token" value="<?php echo isset($_GET['confirmacion_contrasena']) ? $_GET['confirmacion_contrasena'] : ''; ?>" required />
    </div>
    <div class="relative flex w-full flex-col flex-wrap items-stretch mb-4">
        <input type="password" name="contrasena" placeholder="nueva contraseña" class="px-4 py-3 placeholder-gray-400 text-gray-700 bg-white border border-gray-300 rounded-lg text-base w-full" required />
    </div>
