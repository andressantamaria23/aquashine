...
<head>
    ...
    <style>
        .swiper-button-next, .swiper-button-prev {
            color: rgb(245, 0, 0); /* Color de las flechas */
            top: 50%; /* Centra verticalmente las flechas */
            transform: translateY(-20%); /* Ajusta el centrado vertical */
        }
    </style>
</head>
<body class=" mx-auto mt-5 bg-zinc-50 font-[Poppins] ">
    ...
    <div class="container bg-gray-900 grid grid-cols-2 mx-auto flex items-center justify-center min-h-screen mt-6">
      <div class="text-center text-4xl  text-gray-200 my-10">
    ...
    <div class="relative mx-auto grid grid-cols-1 gap-3  max-w-5xl">
      <div class="text-center text-6xl font-bold text-blue-600 bg-gray-900 my-5 shadow-lg">
    ...
    <div
    class="mx-auto mt-5 block rounded-lg bg-white text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white">
    <div
      class="border-b-2 border-neutral-100 px-6 py-3 dark:border-white/10 text-center text-6xl bg-gray-900">
    ...
    <div class=" grid grid-cols-2 p-6 gap-4 bg-gray-900">
      ...
      <blockquote>
        ...
        <p class="text-gray-200">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit sed eum itaque adipisci, libero hic excepturi ut architecto? Dicta molestias eum esse fugit amet suscipit nobis impedit repellat autem earum. 
        </p>
      </blockquote>
